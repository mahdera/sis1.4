 ...
 * 
 */
public class KeyStageOneEndYearEvaluation {
	private long id;
	 ...
	 * 
	 */
	public KeyStageOneEndYearEvaluation() {
	}
	 ...
	 */
	public KeyStageOneEndYearEvaluation(int sectionId, String studentId,
	 ...
	 * @param modificationDate
	 */
	public KeyStageOneEndYearEvaluation(long id, int sectionId, String studentId,
			String literacyReadingAchievement, int literacyReadingEffort,
			String literacyWritingAchievement, int literacyWritingEffort,
			String literacySpeakingAndListeningAchievement,
			int literacySpeakingAndListeningEffort,
	...
	public void save() {
		try {
			String sqlStr = "insert into tbl_key_stage_one_end_year_evaluation values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public static void update(KeyStageOneEndYearEvaluation keyStageOneEndYearEvaluation) {
		try {
			String sqlStr = "update tbl_key_stage_one_end_year_evaluation set section_id = ?," +
			...
			PreparedStatement pStmt = DBConnection.getPreparedStatement(sqlStr);
			pStmt.setInt(1, keyStageOneEndYearEvaluation.getSectionId());
			pStmt.setString(2, keyStageOneEndYearEvaluation.getStudentId());
			pStmt.setString(3, keyStageOneEndYearEvaluation.getLiteracyReadingAchievement());
			pStmt.setInt(4, keyStageOneEndYearEvaluation.getLiteracyReadingEffort());
			pStmt.setString(5, keyStageOneEndYearEvaluation.getLiteracyWritingAchievement());
			pStmt.setInt(6, keyStageOneEndYearEvaluation.getLiteracyWritingEffort());
			pStmt.setString(7, keyStageOneEndYearEvaluation.getLiteracySpeakingAndListeningAchievement());
			pStmt.setInt(8, keyStageOneEndYearEvaluation.getLiteracySpeakingAndListeningEffort());
			pStmt.setString(9, keyStageOneEndYearEvaluation.getLiteracyClassTeacherComments());
			pStmt.setString(10, keyStageOneEndYearEvaluation.getNumeracyNumberAndCalculationAchievement());
			pStmt.setInt(11, keyStageOneEndYearEvaluation.getNumeracyNumberAndCalcualtionEffort());
			pStmt.setString(12, keyStageOneEndYearEvaluation.getNumeracyShapeSpaceAndMeasureAchievement());
			pStmt.setInt(13, keyStageOneEndYearEvaluation.getNumeracyShapeSpaceAndMeasureEffort());
			pStmt.setString(14, keyStageOneEndYearEvaluation.getNumeracyDataHandlingAchievement());
			pStmt.setInt(15, keyStageOneEndYearEvaluation.getNumeracyDataHandlingEffort());
			pStmt.setString(16, keyStageOneEndYearEvaluation.getNumeracyProblemSolvingAchievement());
			pStmt.setInt(17, keyStageOneEndYearEvaluation.getNumeracyProblemSolvingEffort());
			pStmt.setString(18, keyStageOneEndYearEvaluation.getNumeracyClassTeacherComments());
			pStmt.setString(19, keyStageOneEndYearEvaluation.getIpcScienceAchievement());
			pStmt.setInt(20, keyStageOneEndYearEvaluation.getIpcScienceEffort());
			pStmt.setString(21, keyStageOneEndYearEvaluation.getIpcHumanitiesAchievement());
			pStmt.setInt(22, keyStageOneEndYearEvaluation.getIpcHumanitiesEffort());
			pStmt.setString(23, keyStageOneEndYearEvaluation.getIpcArtAndDesignAchievement());
			pStmt.setInt(24, keyStageOneEndYearEvaluation.getIpcArtAndDesignEffort());
			pStmt.setString(25, keyStageOneEndYearEvaluation.getIpcClassTeacherComments());
			pStmt.setString(26, keyStageOneEndYearEvaluation.getClassTeacherGeneralComments());
			pStmt.setString(27, keyStageOneEndYearEvaluation.getSuggestedTargestForthcomingYear());			
			pStmt.setInt(28, keyStageOneEndYearEvaluation.getModifiedBy());
			pStmt.setDate(29, keyStageOneEndYearEvaluation.getModificationDate());
			pStmt.setLong(30, keyStageOneEndYearEvaluation.getId());
			DBConnection.writeToDatabase(pStmt);
	...
	public static void delete(long id) {
		try {
			String sqlStr = "delete from tbl_key_stage_one_end_year_evaluation where id = ?";
			PreparedStatement pStmt = DBConnection.getPreparedStatement(sqlStr);
			pStmt.setLong(1, id);
			DBConnection.writeToDatabase(pStmt);
		} catch (Exception e) {
	...
	public static List<KeyStageOneEndYearEvaluation> getAllKeyStageOneEndYearEvaluations() {
		List<KeyStageOneEndYearEvaluation> list = new ArrayList<KeyStageOneEndYearEvaluation>();
		KeyStageOneEndYearEvaluation keyStageOneEndYearEvaluation = null;
		try {
			String query = "select * from tbl_key_stage_one_end_year_evaluation order by modification_date desc";
			ResultSet rSet = DBConnection.readFromDatabase(query);
			while(rSet.next()){
				keyStageOneEndYearEvaluation = new KeyStageOneEndYearEvaluation(rSet.getLong("id"), rSet.getInt("section_id"), 
				...
				list.add(keyStageOneEndYearEvaluation);
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public static KeyStageOneEndYearEvaluation getKeyStageOneEndYearEvaluation(long id) {
		KeyStageOneEndYearEvaluation keyStageOneEndYearEvaluation = null;
		try {
			String query = "select * from tbl_key_stage_one_end_year_evaluation where id = "+id;
			ResultSet rSet = DBConnection.readFromDatabase(query);
			while(rSet.next()){
				keyStageOneEndYearEvaluation = new KeyStageOneEndYearEvaluation(rSet.getLong("id"), rSet.getInt("section_id"), 
						rSet.getString("student_id"), rSet.getString("literacy_reading_achievement"), 
		...
		return keyStageOneEndYearEvaluation;
	}
	...
	public static boolean resultAlreadySavedForThisStudentAndAcademicYear(String studentIdNumber,int academicYear){
		...
		try{
			String query = "select count(*) as cnt from tbl_key_stage_one_end_year_evaluation where student_id = '"+studentIdNumber+"' and " +
	...
	public static List<KeyStageOneEndYearEvaluation> getAllKeyStageOneEndYearEvaluationsForThisSectionAndAcademicYear(int sectionId, int academicYear){
		List<KeyStageOneEndYearEvaluation> list = new ArrayList<KeyStageOneEndYearEvaluation>();
		KeyStageOneEndYearEvaluation keyStageOneEndYearEvaluation = null;
		try{
			String query = "select * from tbl_key_stage_one_end_year_evaluation where DATE_FORMAT(date_created, '%Y') = "+
	...
	public String toString() {
		return "KeyStageOneEndYearEvaluation [id=" + id + ", sectionId="
				+ sectionId + ", studentId=" + studentId
				+ ", literacyReadingAchievement=" + literacyReadingAchievement
				+ ", literacyReadingEffort=" + literacyReadingEffort
				+ ", literacyWritingAchievement=" + literacyWritingAchievement
				+ ", literacyWritingEffort=" + literacyWritingEffort
				+ ", literacySpeakingAndListeningAchievement="
				+ literacySpeakingAndListeningAchievement
				+ ", literacySpeakingAndListeningEffort="
				+ literacySpeakingAndListeningEffort
				+ ", literacyClassTeacherComments="
				+ literacyClassTeacherComments
				+ ", numeracyNumberAndCalculationAchievement="
				+ numeracyNumberAndCalculationAchievement
				+ ", numeracyNumberAndCalcualtionEffort="
				+ numeracyNumberAndCalcualtionEffort
				+ ", numeracyShapeSpaceAndMeasureAchievement="
				+ numeracyShapeSpaceAndMeasureAchievement
				+ ", numeracyShapeSpaceAndMeasureEffort="
				+ numeracyShapeSpaceAndMeasureEffort
				+ ", numeracyDataHandlingAchievement="
				+ numeracyDataHandlingAchievement
				+ ", numeracyDataHandlingEffort=" + numeracyDataHandlingEffort
				+ ", numeracyProblemSolvingAchievement="
				+ numeracyProblemSolvingAchievement
				+ ", numeracyProblemSolvingEffort="
				+ numeracyProblemSolvingEffort
				+ ", numeracyClassTeacherComments="
				+ numeracyClassTeacherComments + ", ipcScienceAchievement="
				+ ipcScienceAchievement + ", ipcScienceEffort="
				+ ipcScienceEffort + ", ipcHumanitiesAchievement="
				+ ipcHumanitiesAchievement + ", ipcHumanitiesEffort="
				+ ipcHumanitiesEffort + ", ipcArtAndDesignAchievement="
				+ ipcArtAndDesignAchievement + ", ipcArtAndDesignEffort="
				+ ipcArtAndDesignEffort + ", ipcClassTeacherComments="
				+ ipcClassTeacherComments + ", classTeacherGeneralComments="
				+ classTeacherGeneralComments
				+ ", suggestedTargestForthcomingYear="
				+ suggestedTargestForthcomingYear + ", dateCreated="
				+ dateCreated + ", modifiedBy=" + modifiedBy
