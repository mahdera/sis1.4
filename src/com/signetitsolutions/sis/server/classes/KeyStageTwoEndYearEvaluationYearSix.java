 ...
 *
 */
public class KeyStageTwoEndYearEvaluationYearSix {
	private long id;
	...
	private String literacyVocabularyGrammarPunctuationAchievement;
	private int literacyVocabularyGrammarPunctuationEffort;
	 ...
	 * 
	 */
	public KeyStageTwoEndYearEvaluationYearSix() {
	}
	 ...
	 * @param literacyVocabularyGrammarPunctuationAchievement
	 * @param literacyVocabularyGrammarPunctuationEffort
	 ...
	 */
	public KeyStageTwoEndYearEvaluationYearSix(int sectionId, String studentId,
			...
			String literacyVocabularyGrammarPunctuationAchievement,
			int literacyVocabularyGrammarPunctuationEffort,
		...
		this.literacyVocabularyGrammarPunctuationAchievement = literacyVocabularyGrammarPunctuationAchievement;
		this.literacyVocabularyGrammarPunctuationEffort = literacyVocabularyGrammarPunctuationEffort;
	 ...
	 * @param modificationDate
	 */
	public KeyStageTwoEndYearEvaluationYearSix(long id, int sectionId, String studentId,
			String literacyReadingAchievement, int literacyReadingEffort,
			String literacyWritingAchievement, int literacyWritingEffort,
			String literacySpeakingAndListeningAchievement,
			int literacySpeakingAndListeningEffort,
			String literacyVocabularyGrammarPunctuationAchievement,
			int literacyVocabularyGrammarPuncturationEffort,
			String literacyClassTeacherComments,
			String numeracyNumberAndCalculationAchievement,
			int numeracyNumberAndCalcualtionEffort,
			String numeracyShapeSpaceAndMeasureAchievement,
		...
		this.literacySpeakingAndListeningEffort = literacySpeakingAndListeningEffort;
		this.literacyVocabularyGrammarPunctuationAchievement = literacyVocabularyGrammarPunctuationAchievement;
		this.literacyVocabularyGrammarPunctuationEffort = literacyVocabularyGrammarPuncturationEffort;
		this.literacyClassTeacherComments = literacyClassTeacherComments;
		this.numeracyNumberAndCalculationAchievement = numeracyNumberAndCalculationAchievement;
		this.numeracyNumberAndCalcualtionEffort = numeracyNumberAndCalcualtionEffort;
		this.numeracyShapeSpaceAndMeasureAchievement = numeracyShapeSpaceAndMeasureAchievement;
	...
	/**
	 * @return the literacyVocabularyGrammarPunctuationAchievement
	 */
	public String getLiteracyVocabularyGrammarPunctuationAchievement() {
		return literacyVocabularyGrammarPunctuationAchievement;
	}


	/**
	 * @param literacyVocabularyGrammarPunctuationAchievement the literacyVocabularyGrammarPunctuationAchievement to set
	 */
	public void setLiteracyVocabularyGrammarPunctuationAchievement(
			String literacyVocabularyGrammarPunctuationAchievement) {
		this.literacyVocabularyGrammarPunctuationAchievement = literacyVocabularyGrammarPunctuationAchievement;
	}
	...
	/**
	 * @return the literacyVocabularyGrammarPunctuationEffort
	 */
	public int getLiteracyVocabularyGrammarPunctuationEffort() {
		return literacyVocabularyGrammarPunctuationEffort;
	}


	/**
	 * @param literacyVocabularyGrammarPunctuationEffort the literacyVocabularyGrammarPunctuationEffort to set
	 */
	public void setLiteracyVocabularyGrammarPunctuationEffort(
			int literacyVocabularyGrammarPunctuationEffort) {
		this.literacyVocabularyGrammarPunctuationEffort = literacyVocabularyGrammarPunctuationEffort;
	}
	...
	public void save() {
		try {
			String sqlStr = "insert into tbl_key_stage_two_end_year_evaluation_year_six values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
			...
			pStmt.setString(10, this.getLiteracyVocabularyGrammarPunctuationAchievement());
			pStmt.setInt(11, this.getLiteracyVocabularyGrammarPunctuationEffort());
			pStmt.setString(12, this.getLiteracyClassTeacherComments());
			pStmt.setString(13, this.getNumeracyNumberAndCalculationAchievement());
			pStmt.setInt(14, this.getNumeracyNumberAndCalcualtionEffort());
			pStmt.setString(15, this.getNumeracyShapeSpaceAndMeasureAchievement());
			pStmt.setInt(16, this.getNumeracyShapeSpaceAndMeasureEffort());
			pStmt.setString(17, this.getNumeracyDataHandlingAchievement());
			pStmt.setInt(18, this.getNumeracyDataHandlingEffort());
			pStmt.setString(19, this.getNumeracyProblemSolvingAchievement());
			pStmt.setInt(20, this.getNumeracyProblemSolvingEffort());
			pStmt.setString(21, this.getNumeracyClassTeacherComments());
			pStmt.setString(22, this.getIpcScienceAchievement());
			pStmt.setInt(23, this.getIpcScienceEffort());
			pStmt.setString(24, this.getIpcHumanitiesAchievement());
			pStmt.setInt(25, this.getIpcHumanitiesEffort());
			pStmt.setString(26, this.getIpcArtAndDesignAchievement());
			pStmt.setInt(27, this.getIpcArtAndDesignEffort());
			pStmt.setString(28, this.getIpcClassTeacherComments());
			pStmt.setString(29, this.getClassTeacherGeneralComments());
			pStmt.setString(30, this.getSuggestedTargestForthcomingYear());
			pStmt.setDate(31, this.getDateCreated());
			pStmt.setInt(32, this.getModifiedBy());
			pStmt.setDate(33, this.getModificationDate());
	...
	public static void update(KeyStageTwoEndYearEvaluationYearSix keyStageTwoEndYearEvaluationYearSix) {
		try {
			String sqlStr = "update tbl_key_stage_two_end_year_evaluation_year_six set section_id = ?," +
					...
					"literacy_vocabulary_grammar_punctuation_achievement = ?," +
					"literacy_vocabulary_grammar_punctuation_effort = ?," +
			...
			PreparedStatement pStmt = DBConnection.getPreparedStatement(sqlStr);
			pStmt.setInt(1, keyStageTwoEndYearEvaluationYearSix.getSectionId());
			pStmt.setString(2, keyStageTwoEndYearEvaluationYearSix.getStudentId());
			pStmt.setString(3, keyStageTwoEndYearEvaluationYearSix.getLiteracyReadingAchievement());
			pStmt.setInt(4, keyStageTwoEndYearEvaluationYearSix.getLiteracyReadingEffort());
			pStmt.setString(5, keyStageTwoEndYearEvaluationYearSix.getLiteracyWritingAchievement());
			pStmt.setInt(6, keyStageTwoEndYearEvaluationYearSix.getLiteracyWritingEffort());
			pStmt.setString(7, keyStageTwoEndYearEvaluationYearSix.getLiteracySpeakingAndListeningAchievement());
			pStmt.setInt(8, keyStageTwoEndYearEvaluationYearSix.getLiteracySpeakingAndListeningEffort());
			pStmt.setString(9, keyStageTwoEndYearEvaluationYearSix.getLiteracyVocabularyGrammarPunctuationAchievement());
			pStmt.setInt(10, keyStageTwoEndYearEvaluationYearSix.getLiteracyVocabularyGrammarPunctuationEffort());
			pStmt.setString(11, keyStageTwoEndYearEvaluationYearSix.getLiteracyClassTeacherComments());
			pStmt.setString(12, keyStageTwoEndYearEvaluationYearSix.getNumeracyNumberAndCalculationAchievement());
			pStmt.setInt(13, keyStageTwoEndYearEvaluationYearSix.getNumeracyNumberAndCalcualtionEffort());
			pStmt.setString(14, keyStageTwoEndYearEvaluationYearSix.getNumeracyShapeSpaceAndMeasureAchievement());
			pStmt.setInt(15, keyStageTwoEndYearEvaluationYearSix.getNumeracyShapeSpaceAndMeasureEffort());
			pStmt.setString(16, keyStageTwoEndYearEvaluationYearSix.getNumeracyDataHandlingAchievement());
			pStmt.setInt(17, keyStageTwoEndYearEvaluationYearSix.getNumeracyDataHandlingEffort());
			pStmt.setString(18, keyStageTwoEndYearEvaluationYearSix.getNumeracyProblemSolvingAchievement());
			pStmt.setInt(19, keyStageTwoEndYearEvaluationYearSix.getNumeracyProblemSolvingEffort());
			pStmt.setString(20, keyStageTwoEndYearEvaluationYearSix.getNumeracyClassTeacherComments());
			pStmt.setString(21, keyStageTwoEndYearEvaluationYearSix.getIpcScienceAchievement());
			pStmt.setInt(22, keyStageTwoEndYearEvaluationYearSix.getIpcScienceEffort());
			pStmt.setString(23, keyStageTwoEndYearEvaluationYearSix.getIpcHumanitiesAchievement());
			pStmt.setInt(24, keyStageTwoEndYearEvaluationYearSix.getIpcHumanitiesEffort());
			pStmt.setString(25, keyStageTwoEndYearEvaluationYearSix.getIpcArtAndDesignAchievement());
			pStmt.setInt(26, keyStageTwoEndYearEvaluationYearSix.getIpcArtAndDesignEffort());
			pStmt.setString(27, keyStageTwoEndYearEvaluationYearSix.getIpcClassTeacherComments());
			pStmt.setString(28, keyStageTwoEndYearEvaluationYearSix.getClassTeacherGeneralComments());
			pStmt.setString(29, keyStageTwoEndYearEvaluationYearSix.getSuggestedTargestForthcomingYear());			
			pStmt.setInt(30, keyStageTwoEndYearEvaluationYearSix.getModifiedBy());
			pStmt.setDate(31, keyStageTwoEndYearEvaluationYearSix.getModificationDate());
			pStmt.setLong(32, keyStageTwoEndYearEvaluationYearSix.getId());
			DBConnection.writeToDatabase(pStmt);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public static void delete(long id) {
		try {
			String sqlStr = "delete from tbl_key_stage_two_end_year_evaluation_year_six where id = ?";
			PreparedStatement pStmt = DBConnection.getPreparedStatement(sqlStr);
			pStmt.setLong(1, id);
			DBConnection.writeToDatabase(pStmt);
		} catch (Exception e) {
	...
	public static List<KeyStageTwoEndYearEvaluationYearSix> getAllKeyStageTwoEndYearEvaluationYearSix() {
		List<KeyStageTwoEndYearEvaluationYearSix> list = new ArrayList<KeyStageTwoEndYearEvaluationYearSix>();
		KeyStageTwoEndYearEvaluationYearSix keyStageTwoEndYearEvaluationYearSix = null;
		try {
			String query = "select * from tbl_key_stage_two_end_year_evaluation_year_six order by modification_date desc";
			ResultSet rSet = DBConnection.readFromDatabase(query);
			while(rSet.next()){
				keyStageTwoEndYearEvaluationYearSix = new KeyStageTwoEndYearEvaluationYearSix(rSet.getLong("id"), rSet.getInt("section_id"), 
						...
						rSet.getString("literacy_vocabulary_grammar_punctuation_achievement"),
						rSet.getInt("literacy_vocabulary_grammar_punctuation_effort"),
						...
						rSet.getString("suggested_targets_forthcoming_year"), 
						rSet.getDate("date_created"),rSet.getInt("modified_by"), 
						rSet.getDate("modification_date"));
				list.add(keyStageTwoEndYearEvaluationYearSix);
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public static KeyStageTwoEndYearEvaluationYearSix getKeyStageTwoEndYearEvaluationYearSix(long id) {
		KeyStageTwoEndYearEvaluationYearSix keyStageTwoEndYearEvaluationYearSix = null;
		try {
			String query = "select * from tbl_key_stage_two_end_year_evaluation_year_six where id = "+id;
			ResultSet rSet = DBConnection.readFromDatabase(query);
			while(rSet.next()){
				keyStageTwoEndYearEvaluationYearSix = new KeyStageTwoEndYearEvaluationYearSix(rSet.getLong("id"), rSet.getInt("section_id"), 
						rSet.getString("student_id"), rSet.getString("literacy_reading_achievement"), 
		...
		return keyStageTwoEndYearEvaluationYearSix;
	}
	...
	public static boolean resultAlreadySavedForThisStudentAndAcademicYear(String studentIdNumber,int academicYear){
		...
		try{
			String query = "select count(*) as cnt from tbl_key_stage_two_end_year_evaluation_year_six where student_id = '"+studentIdNumber+"' and " +
	...
	public static List<KeyStageTwoEndYearEvaluationYearSix> getAllKeyStageTwoYearSixEndYearEvaluationsForThisSectionAndAcademicYear(int sectionId, int academicYear){
		List<KeyStageTwoEndYearEvaluationYearSix> list = new ArrayList<KeyStageTwoEndYearEvaluationYearSix>();
		KeyStageTwoEndYearEvaluationYearSix keyStageTwoEndYearEvaluationYearSix = null;
		try{
			String query = "select * from tbl_key_stage_two_end_year_evaluation_year_six where DATE_FORMAT(date_created, '%Y') = "+
