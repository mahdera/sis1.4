...
<%
	...
	List<Section1> keyStageTwoList = Section1.getAllSectionsOfThisLevel("Year 3 (Yr3)", "Year 4 (Yr4)", "Year 5 (Yr5)", "Year 6 (Yr6)");
	...
	$(document).ready(function(){
		$('#btnshowreportkeystagetwo').click(function(){
			...
			if(sectionId != "" && academicYear != ""){
				$('#keyStageTwoReportDisplayDiv').load("showlistofamharickeystagetwoevaluationforthissectionandacademicyeareditresult.jsp?sectionId="+
