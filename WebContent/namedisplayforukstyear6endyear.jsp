...
<script type="text/javascript">
	$(document).ready(function(){
		$('#txtsid').change(function(){
			var id = $('#txtsid').val();
			if(id != ""){
				var table = "KeyStageTwoYearSix";
				var evaluationType = "end-year";
				...
				$.ajax({
				    ...
				    success:function(response){				    		
				    		if(response.trim() == "Saved"){				    			
				    			$('#textdesp').html("<p class='msg warning'>End-year result is already saved for this student in this academic year!</p>");
							...
							$('#textdesp').load("narrationupperkeysatgetwoyear6endyearprimaryscoolreport.jsp?id="+id);
				    		}					
				    },
				    error:function(error){
						alert(error);
