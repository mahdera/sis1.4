...
<%
	...
	MusicKeyStageTwo musicKeyStageTwo = MusicKeyStageTwo.getMusicKeyStageTwo(id);
	...
	Section1 section = Section1.getSectionUsingId(musicKeyStageTwo.getSectionId());
%>
...
<table border="0" width="100%" style="border: 0px solid #2779aa;" rules="all">
	<tr>
		<td style="font-weight:bold;font-size:12pt;text-align:center" colspan="3">
			...
			Music Key Stage Two Primary School Report
		</td>
	</tr>
	<tr>
		...
		<tr>
			<td colspan="2">
				<table border="0" width="100%" style="border: 0px solid #2779aa;" rules="all">
					...
					<tr>	
						<td>Performing</td>
						<td>
							<%=musicKeyStageTwo.getPerformingAchievement() %>
						</td>
						<td>
							<%=musicKeyStageTwo.getPerformingEffort() %>	
						</td>						
					</tr>
					<tr>	
						<td>Creative and Listening skills </td>
						<td>
							<%=musicKeyStageTwo.getCreativeAndListeningSkillsAchievement() %>
						</td>
						<td>
							<%=musicKeyStageTwo.getCreativeAndListeningSkillsEffort() %>
						</td>						
					</tr>
				</table>
			</td>
			<td width="50%" style="vertical-align:top">
				<table border="0" width="100%" style="border: 0px solid #2779aa;" rules="all">
					...
					<tr>
						<td>
							<%=musicKeyStageTwo.getClassTeacherComments() %>		
						</td>
					</tr>
				</table>				
			</td>
