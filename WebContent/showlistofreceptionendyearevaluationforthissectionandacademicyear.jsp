		...
		while(earlyYearsEndYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showReceptionEndYearReportDetail(<%=earlyYearsEndYearEvaluation.getId() %>);" class="showReportLinkClass">Show Detail</a>
						|
...
<script type="text/javascript">
	function showReceptionEndYearReportDetail(id){
		var divId = "receptionEndYearReportDiv" + id;
		$('#'+divId).load("showreceptionendyearreportdetail.jsp?id="+id);
	}
