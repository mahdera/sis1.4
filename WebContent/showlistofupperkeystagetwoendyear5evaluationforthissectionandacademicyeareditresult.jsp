		...
		while(keyStageTwoEndYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showKeyStageTwoEndYear5ReportDetailEditResult(<%=keyStageTwoEndYearEvaluation.getId() %>);" class="showReportLinkClass">Edit Detail</a>
						|
...
<script type="text/javascript">
	function showKeyStageTwoEndYear5ReportDetailEditResult(id){
		var divId = "keyStageTwoEndYearReportDiv" + id;
		$('#'+divId).load("showupperkeystagetwoendyear5reportdetaileditresult.jsp?id="+id);
	}
