		...
		while(keyStageTwoEndYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showKeyStageTwoEndYear5ReportDetail(<%=keyStageTwoEndYearEvaluation.getId() %>);" class="showReportLinkClass">Show Detail</a>
						|
...
<script type="text/javascript">
	function showKeyStageTwoEndYear5ReportDetail(id){
		var divId = "keyStageTwoEndYearReportDiv" + id;
		$('#'+divId).load("showupperkeystagetwoendyear5reportdetail.jsp?id="+id);
	}
