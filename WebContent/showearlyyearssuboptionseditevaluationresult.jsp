		...
		$('#slctearlyyearssuboptions').change(function(){
			...
			if(selectedReportType != ""){
				if(selectedReportType == "nursery_mid_year_report"){
					$('#earlyYearsSubOptionsDiv').load('shownurserymidyearclassandacademicyearselectorbareditevaluationresult.jsp');
				}else if(selectedReportType == "nursery_end_year_report"){
					$('#earlyYearsSubOptionsDiv').load('shownurseryendyearclassandacademicyearselectorbareditevaluationresult.jsp');
				}else if(selectedReportType == "reception_mid_year_report"){
					$('#earlyYearsSubOptionsDiv').load('showreceptionmidyearclassandacademicyearselectorbareditevaluationresult.jsp');
				}else if(selectedReportType == "reception_end_year_report"){
					$('#earlyYearsSubOptionsDiv').load('showreceptionendyearclassandacademicyearselectorbareditevaluationresult.jsp');
				}
			}
		});
