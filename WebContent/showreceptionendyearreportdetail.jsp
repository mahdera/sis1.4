	...
	<tr>
		<td colspan="6">
			<table border="0" width="100%" style="border: 0px solid #2779aa;" rules="all">
				...
				<tr>
					<td>
						<%=earlyYearsEndYearEvaluation.getPersonalSocialEmotionalDevelopment() %>
					</td>
					<td>
						<%=earlyYearsEndYearEvaluation.getCommunicationAndLanguage() %>
					</td>
				</tr>				
				<tr style="background:#eee;font-weight:bolder">
				...
				<tr>
					<td>
						<%=earlyYearsEndYearEvaluation.getPhysicalDevelopment() %>
					</td>
					<td>
						<%=earlyYearsEndYearEvaluation.getLiteracy() %>
					</td>
				</tr>				
				<tr style="background:#eee;font-weight:bolder">
					<td>Mathematics</td>
				...
				<tr>
					<td>
						<%=earlyYearsEndYearEvaluation.getMathematics() %>
					</td>
					<td>
						<%=earlyYearsEndYearEvaluation.getUnderstandingTheWorld() %>
					</td>
				</tr>				
				<tr style="background:#eee;font-weight:bolder">
				...
				<tr>
					<td>
						<%=earlyYearsEndYearEvaluation.getExpressiveArtsAndDesign() %>
					</td>
					<td>
						<%=earlyYearsEndYearEvaluation.getGeneralComments() %>
					</td>
				</tr>				
			</table>
		</td>
