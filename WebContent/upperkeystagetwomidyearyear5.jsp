...
<%
	List<Section1> keyStageTwoSectionList = Section1.getAllSectionsOfThisLevel("Year 5 (Yr5)");
...
<center style="font-size:15pt"><b>PRIMARY SCHOOL MID YEAR REPORT for YEAR 5</b></center>
<%
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#txtsection').change(function(){
			...
			if(id != ""){
				$('#namedisp').load("namedisplayforukstyear5midyear.jsp?id="+id);
			}
		});
