		...
		while(nurseryMidYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showNurseryMidYearReportDetail(<%=nurseryMidYearEvaluation.getId() %>);" class="showReportLinkClass">Show Detail</a>
						|
...
<script type="text/javascript">
	function showNurseryMidYearReportDetail(id){
		var divId = "nurseryMidYearReportDiv" + id;
		$('#'+divId).load("shownurserymidyearreportdetail.jsp?id="+id);
	}
