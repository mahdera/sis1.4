					...
					<td colspan="2">
						<fieldset>
							...
							<table border="1" width="100%">
								...
								<div id="tabDetailDiv"> 			
									<p class="msg info">No father information found</p>			
								</div>	
								<%} %>															
							</table>
						</fieldset>
					...
					<td colspan="2">
						<fieldset>
							...
							<table border="1" width="100%">
								...
								<div id="tabDetailDiv"> 			
									<p class="msg info">No mother information found</p>			
								</div>	
								<%} %>	
						</fieldset>
					</td>
						...
						<fieldset>
							...
							<table border="1" width="100%">
								...
								<tr>
									...
									<td>
										<input type="button" value="Put to Waiting List" onclick=""/>
									</td>
									<td>
										<input type="button" value="Reject Application" onclick=""/>
									</td>
								</tr>
								<tr>
									<td colspan="3">
