			...
			<td colspan="3" style="vertical-align:top;padding-top:34px">
				<table border="0" width="100%">
					<tr>						
						...
						<td>
							<select name="slctsceicneeffort" id="slctsceicneeffort" style="width:100%">
								<option value="" selected="selected">--Select--</option>
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btnsave').click(function(){
			...
			var scienceEffort = $('#slctsceicneeffort').val();
			...
			if(sectionId != "" && studentIdNumber != "" && literacyAchievement != "" &&
					...
					numeracyAchievement != "" && numeracyEffort != "" &&
					numeracyClassTeacherComments != "" && ipcAchievement != "" &&
					ipcEffort != "" && ipcClassTeacherComments != "" &&
				...
				"&literacyAchievement="+literacyAchievement+"&literacyEffort="+literacyEffort+
				...
				"&ipcAchievement="+ipcAchievement+
				"&ipcEffort="+ipcEffort+
				"&ipcClassTeacherComments="+ipcClassTeacherComments+
				"&classTeacherGeneralComments="+classTeacherGeneralComments+
				"&scienceAchievement="+scienceAchievement+
				"&scienceEffort="+scienceEffort+
				"&scienceClassTeacherComments="+scienceClassTeacherComments;
				
				$.ajax({
				    url: 'savenarrationupperkeystagetwoyear6midyearprimaryschoolreport.jsp',		
				    data: dataString,
				    type:'POST',
