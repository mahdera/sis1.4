		...
		while(keyStageTwoEndYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showKeyStageTwoEndYearReportDetail(<%=keyStageTwoEndYearEvaluation.getId() %>);" class="showReportLinkClass">Show Detail</a>
						|
...
<script type="text/javascript">
	function showKeyStageTwoEndYearReportDetail(id){
		var divId = "keyStageTwoEndYearReportDiv" + id;
		$('#'+divId).load("showlowerkeystagetwoendyearreportdetail.jsp?id="+id);
	}
