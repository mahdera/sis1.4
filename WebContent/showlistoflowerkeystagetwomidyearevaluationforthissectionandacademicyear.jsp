		...
		while(keyStageTwoMidYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showKeyStageTwoMidYearReportDetail(<%=keyStageTwoMidYearEvaluation.getId() %>);" class="showReportLinkClass">Show Detail</a>
						|
...
<script type="text/javascript">
	function showKeyStageTwoMidYearReportDetail(id){
		var divId = "keyStageTwoMidYearReportDiv" + id;
		$('#'+divId).load("showlowerkeystagetwomidyearreportdetail.jsp?id="+id);
	}
