...
<%
	...
	AmharicKeyStageTwo amharicKeyStageTwo = AmharicKeyStageTwo.getAmharicKeyStageTwo(id);
	...
	Section1 section = Section1.getSectionUsingId(amharicKeyStageTwo.getSectionId());
%>
...
<table border="0" width="100%" style="border: 0px solid #2779aa;" rules="all">
	<tr>
		<td style="font-weight:bold;font-size:12pt;text-align:center" colspan="3">
			...
			Amharic Key Stage Two Primary School Report
		</td>
	</tr>
	<tr>
			...
			<td colspan="3">
				<table border="0" width="100%" style="border: 0px solid #2779aa;" rules="all">
					...
					<tr>
						...
						<td>
							<%=amharicKeyStageTwo.getSpeakingAndListeningAchievement() %>
						</td>
						<td>
							<%=amharicKeyStageTwo.getSpeakingAndListeningEffort() %>
						</td>
					</tr>
					<tr>
						<td>Reading</td>
						<td>
							<%=amharicKeyStageTwo.getReadingAchievement() %>
						</td>
						<td>
							<%=amharicKeyStageTwo.getReadingEffort() %>
						</td>						
					</tr>
					<tr>
						<td>Writing</td>
						<td>
							<%=amharicKeyStageTwo.getWritingAchievement() %>
						</td>
						<td>
							<%=amharicKeyStageTwo.getWritingEffort() %>
						</td>
					</tr>
				</table>
			</td>
				...
				<table border="0" width="100%" style="border: 0px solid #2779aa;" rules="all">
					...
					<tr>
						<td style="vertical-align:top;">
							<%=amharicKeyStageTwo.getClassTeacherComments() %>			
						</td>	
					</tr>
				</table>			
			</td>
