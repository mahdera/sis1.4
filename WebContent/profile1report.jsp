...
<td align="center"><input type="button" value="SHOW" id="btnprofile1finalreport"/></td>
</tr>
</table>
<br/>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#txtsection').change(function(){
			...
			if(id != ""){
				$('#named').load("namediplayforprofile1yearreport.jsp?id="+id);
			}
		});
		
		$('#btnprofile1finalreport').click(function(){
			var sectionId = $('#txtsection').val();
			var studentId = $('#txtsid').val();
			var dob = $('#txtdob').val();
			
			if(sectionId != "" && studentId != "" && dob != ""){
				$('#printdisplay').load("showprofile1report.jsp?secid="+sectionId+"&sid="+studentId+"&dob="+dob);
			}
		});
