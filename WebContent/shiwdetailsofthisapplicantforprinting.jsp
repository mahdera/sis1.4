...
<table border="0" width="100%" style="background:#ffffff">
	<tr>
			...
			<tr>
				<td width="25%" align="right">Parent/Guardina Name:</td>
				<td align="left"><hr style="width:100%"/></td>
			</tr>
			<tr>
				<td width="25%" align="right">Signature:</td>
				<td align="left"><hr style="width:50%"/></td>
			</tr>
</table>
</div>
