				...
				$.ajax({
				    ...
				    success:function(response){				    		
				    		if(response.trim() == "Saved"){				    			
				    			$('#narrationd').html("<p class='msg warning'>Mid-year result is already saved for this student in this academic year!</p>");
							...
							$('#narrationd').load("narrationkeysatgeonemidyearprimaryscoolreport.jsp?id="+id);
				    		}					
				    },
				    error:function(error){
						alert(error);
