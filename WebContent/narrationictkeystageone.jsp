		...
		<tr>
			...
			<td>
				<table border="0" width="100%">
					...
					<tr>
						<td>
							<textarea name="textareaictteacherclasscomments" id="textareaictteacherclasscomments" class="jqte-test"></textarea>		
						</td>
					</tr>
				</table>				
			</td>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btnsave').click(function(){
			...
			var ictClassTeacherComments = $('#textareaictteacherclasscomments').val();
			
			if(sectionId != "" && studentIdNumber != "" && teacherId != "" && learningAndApplicationOfSkillsEffort != "" &&
					evaluationSkillsEffort != "" && ictClassTeacherComments != ""){
				var dataString = "sectionId="+sectionId+"&studentIdNumber="+studentIdNumber+
				"&teacherId="+teacherId+"&learningAndApplicationOfSkillsEffort="+learningAndApplicationOfSkillsEffort+
				"&evaluationSkillsEffort="+evaluationSkillsEffort+"&ictClassTeacherComments="+
				ictClassTeacherComments;
				
				$.ajax({
				    url: 'savenarrationictkeystageone.jsp',		
				    data: dataString,
				    type:'POST',
