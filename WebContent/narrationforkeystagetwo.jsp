...
List<Endofyear> helloList = Endofyear.getKeysatgetwoend(sid.toString());//(sid);
...
<tr>
	...
	<td width="210" align="center" style="vertical-align:top"> 
	...
	<td width="194" align="center" style="vertical-align:top">
		<table border="0" width="100%">
			<tr>
				<td>1</td>
				<td>2</td>
...
<tr>
	...
	<td colspan="4" align="center"><textarea name="txtlwn" style="width:100%" rows="5"  id="txtlwn" ></textarea></td>
</tr>
<tr>
	...
	<td colspan="4" align="center"><textarea name="txtlsln" style="width:100%" rows="5"  id="txtlsln" ></textarea></td>
</tr>
<tr>
...
<tr>
	<td colspan="9" align="center"><textarea name="txtgc" style="width:100%" rows="4"  id="txtgc" ></textarea></td>
</tr>
<tr>
	<th colspan="9" align="left">SUGGESTED TARGETS FOR THE FORTHCOMING YEAR</th>
</tr>
<tr>
	<td colspan="9" align="center"><textarea name="txtst" style="width: 100%" rows="4"  id="txtst" ></textarea></td>
</tr>
<tr>
	<td colspan="9" align="right">
		<input type="button" value="Save" onclick="javascript:saveendofschooll(document.getElementById('txtsid').value,this.form,document.getElementById('txtlrn').value,document.getElementById('txtlwn').value,document.getElementById('txtlsln').value,document.getElementById('txtuaamn').value,document.getElementById('txtnaan').value,document.getElementById('txtssmn').value,document.getElementById('txtdhn').value,document.getElementById('txtisn').value,document.getElementById('txtkacn').value,document.getElementById('txtrsn').value,document.getElementById('txthkacn').value,document.getElementById('txtatn').value,document.getElementById('txtcn').value,document.getElementById('txtgc').value,document.getElementById('txtst').value,display)" class="input-submit"/>		
...
{
	List<Endofyear> helloLista = Endofyear.getKeysatgetwoend(sid);
...
<td colspan="9" align="center"><input type="button" value="Save" onclick="javascript:updateendofschooll(document.getElementById('txtsid').value,this.form,document.getElementById('txtlrn').value,document.getElementById('txtlwn').value,document.getElementById('txtlsln').value,document.getElementById('txtuaamn').value,document.getElementById('txtnaan').value,document.getElementById('txtssmn').value,document.getElementById('txtdhn').value,document.getElementById('txtisn').value,document.getElementById('txtkacn').value,document.getElementById('txtrsn').value,document.getElementById('txthkacn').value,document.getElementById('txtatn').value,document.getElementById('txtcn').value,document.getElementById('txtgc').value,document.getElementById('txtst').value,display)"/></td>
</tr>
</table>
