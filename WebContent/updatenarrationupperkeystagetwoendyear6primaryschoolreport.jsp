...
<%
	...
	keyStageTwoEndYearEvaluation.setLiteracyVocabularyGrammarPunctuationAchievement(literacyVocabularyGrammarPunctuationAchievement);
	keyStageTwoEndYearEvaluation.setLiteracyVocabularyGrammarPunctuationEffort(literacyVocabularyGrammarPunctuationEffort);
	...
	KeyStageTwoEndYearEvaluationYearSix.update(keyStageTwoEndYearEvaluation);
%>
