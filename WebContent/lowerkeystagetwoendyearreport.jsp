...
<center style="font-size:15pt"><b>PRIMARY SCHOOL END YEAR REPORT for YEAR 3-4</b></center>
<%
...
%>
<center style="font-size:13pt"><strong>For the end of the school year <%=formattedAcademicYear %></strong></center>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#txtsection').change(function(){
			...
			if(id != ""){
				$('#namedisp').load("namedisplayforkstendyear.jsp?id="+id);
			}
		});
