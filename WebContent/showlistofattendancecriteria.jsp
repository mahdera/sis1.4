...
<%
	...
	if (role.isReadable() && role.isReadable()){
%>
<form>
	<table border="0" width="100%">
		...
		<tr>
			<td colspan="8" align="right">
				<input type="button" value="Show Attendance Grid" onclick="showListOfStudentsForAttendanceView(document.getElementById('slctsection').value,
								document.getElementById('slctsupervisor').value, document.getElementById('txtdate').value,
