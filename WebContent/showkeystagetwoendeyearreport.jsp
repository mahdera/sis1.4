...
<font size="5"><center><b>SANDFORD INTERNATIONAL SCHOOL</b></center></font>
...
<form name="a">
<%
List<Endofyear> helloListend = Endofyear.getKeysatgetwoend(sid);
...
<td width="111" align="center" valign="middle"><%=enyr.getLre()%></td>
<td width="593" colspan="4" ><%=enyr.getLrn()%></td>
</tr>
...
<table border="1" width="100%" align="center">
<tr>
<th width="195" align="left">CURRICULUM AREA</th>
<th width="119">ACHIEVEMENT</th>
<th width="115">EFFORT</th>
...
<td width="591" colspan="4" align="justify"><%=pe.getPon()%></td>
</tr>
<tr>
...
<%}%>
<tr>
<td colspan=3><b>KeyStage Two Teacher:</b></td>
