...
<%
	...
	KeyStageTwoEndYearEvaluationYearSix keyStageTwoEndYearEvaluation = KeyStageTwoEndYearEvaluationYearSix.getKeyStageTwoEndYearEvaluationYearSix(id);
			...
			<td colspan="3" style="vertical-align:top;">				
				<table border="0" width="100%" style="border: 0px solid #2779aa;" rules="all">
					...
					<tr>
						...
						<td>
							<select name="slctliteracyvocabularygrammarpunctuationachievement" id="slctliteracyvocabularygrammarpunctuationachievement" style="width:100%">
								<option value="" selected="selected">--Select--</option>
								<%
									if(keyStageTwoEndYearEvaluation.getLiteracyVocabularyGrammarPunctuationAchievement().equalsIgnoreCase("e")){
										%>
										<option value="E" selected="selected">E</option>
										<option value="S">S</option>
										<option value="M">M</option>
										<option value="N">N</option>
										<%
									}else if(keyStageTwoEndYearEvaluation.getLiteracyVocabularyGrammarPunctuationAchievement().equalsIgnoreCase("s")){
										%>
										<option value="E">E</option>
										<option value="S" selected="selected">S</option>
										<option value="M">M</option>
										<option value="N">N</option>
										<%		
									}else if(keyStageTwoEndYearEvaluation.getLiteracyVocabularyGrammarPunctuationAchievement().equalsIgnoreCase("m")){
										%>
										<option value="E">E</option>
										<option value="S">S</option>
										<option value="M" selected="selected">M</option>
										<option value="N">N</option>
										<%
									}else if(keyStageTwoEndYearEvaluation.getLiteracyVocabularyGrammarPunctuationAchievement().equalsIgnoreCase("n")){
										%>
										<option value="E">E</option>
										<option value="S">S</option>
										<option value="M">M</option>
						...
						<td>							
							<select name="slctliteracyvocabularygrammarpunctuationeffort" id="slctliteracyvocabularygrammarpunctuationeffort" style="width:100%">
								<option value="" selected="selected">--Select--</option>
								<%
									if(keyStageTwoEndYearEvaluation.getLiteracyVocabularyGrammarPunctuationEffort() == 1){
										%>
										<option value="1" selected="selected">1</option>
										<option value="2">2</option>
										<option value="3">3</option>
										<option value="4">4</option>
										<%
									}else if(keyStageTwoEndYearEvaluation.getLiteracyVocabularyGrammarPunctuationEffort() == 2){
										%>
										<option value="1">1</option>
										<option value="2" selected="selected">2</option>
										<option value="3">3</option>
										<option value="4">4</option>
										<%		
									}else if(keyStageTwoEndYearEvaluation.getLiteracyVocabularyGrammarPunctuationEffort() == 3){
										%>
										<option value="1">1</option>
										<option value="2">2</option>
										<option value="3" selected="selected">3</option>
										<option value="4">4</option>
										<%
									}else if(keyStageTwoEndYearEvaluation.getLiteracyVocabularyGrammarPunctuationEffort() == 4){
										%>
										<option value="1">1</option>
										<option value="2">2</option>
										<option value="3">3</option>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btnupdate').click(function(){
			...
			var literacyVocabularyGrammarPunctuationAchievement = $('#slctliteracyvocabularygrammarpunctuationachievement').val();
			var literacyVocabularyGrammarPunctuationEffort = $('#slctliteracyvocabularygrammarpunctuationeffort').val();
			...
			if(literacyReadingAchievement != "" && literacyReadingEffort != "" && literacyWritingAchievement != "" &&
					...
					literacyVocabularyGrammarPunctuationAchievement != "" &&
					literacyVocabularyGrammarPunctuationEffort != ""){
				...
				"&literacyVocabularyGrammarPunctuationAchievement="+literacyVocabularyGrammarPunctuationAchievement+
				"&literacyVocabularyGrammarPunctuationEffort="+literacyVocabularyGrammarPunctuationEffort;
				var divId = "keyStageTwoEndYearReportDiv" + id;
				
				$.ajax({
				    url: 'updatenarrationupperkeystagetwoendyear6primaryschoolreport.jsp',		
				    data: dataString,
				    type:'POST',
