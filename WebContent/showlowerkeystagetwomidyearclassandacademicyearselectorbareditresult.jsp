...
<%
	...
	List<Section1> keyStageTwoList = Section1.getAllSectionsOfThisLevel("Year 3 (Yr3)", "Year 4 (Yr4)");
	...
	$(document).ready(function(){
		$('#btnshowreportkeystagetwo').click(function(){
			...
			if(sectionId != "" && academicYear != ""){
				$('#keyStageTwoReportDisplayDiv').load("showlistoflowerkeystagetwomidyearevaluationforthissectionandacademicyeareditresult.jsp?sectionId="+
