...
<script type="text/javascript">
	$(document).ready(function(){
		$('#slctcategory').change(function(){
			...
			if(menu != ""){
				if(menu == "early_years"){
					$('#showreception').load("showearlyyearssuboptionseditevaluationresult.jsp");
				}else if(menu == "key_stage_one"){
					$('#showreception').load("showkeystageonesuboptionseditevaluationresult.jsp");
				}else if(menu == "key_stage_two"){
					$('#showreception').load("showkeystagetwosuboptionseditevaluationresult.jsp");
				}else if(menu == "specialist_class"){
					$('#showreception').load("showspecialistclasssuboptionseditevaluationresult.jsp");
				}
			}
		});
