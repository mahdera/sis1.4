		...
		while(keyStageTwoMidYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showKeyStageTwoMidYearReportDetailEditResult(<%=keyStageTwoMidYearEvaluation.getId() %>);" class="showReportLinkClass">Edit Detail</a>
						|
...
<script type="text/javascript">
	function showKeyStageTwoMidYearReportDetailEditResult(id){
		var divId = "keyStageTwoMidYearReportDiv" + id;
		$('#'+divId).load("showlowerkeystagetwomidyearreportdetaileditresult.jsp?id="+id);
	}
