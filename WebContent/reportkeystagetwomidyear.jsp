...
<td width="172" align="center"><div align="center"> <select id="txtsection" onchange="midyearreportforkstreporta(this.value)">
...
<td align="center"><input type="button" value="SHOW" onClick="javascript:midyearreportforkstreport(document.getElementById('txtsection').value,document.getElementById('txtsid').value,document.getElementById('txtage').value)"/></td>
</tr>
</table>
<br/>
