...
<%
	...
	List<Section1> keyStageTwoList = Section1.getAllSectionsOfThisLevel("Year 5 (Yr5)");
	...
	$(document).ready(function(){
		$('#btnshowreportkeystagetwo').click(function(){
			...
			if(sectionId != "" && academicYear != ""){
				$('#keyStageTwoReportDisplayDiv').load("showlistofupperkeystagetwoyear5midyearevaluationforthissectionandacademicyeareditresult.jsp?sectionId="+
