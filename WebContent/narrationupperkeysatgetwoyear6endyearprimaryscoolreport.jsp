			...
			<td colspan="3" style="vertical-align:top;padding-top:34px">				
				<table border="0" width="100%">
					...
					<tr>
						...
						<td>
							<select name="slctliteracyeffortvocabularygrammarpunctuation" id="slctliteracyeffortvocabularygrammarpunctuation" style="width:100%">
								<option value="" selected="selected">--Select--</option>
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btnsave').click(function(){
			...
			var literacyVocabularyGrammarPunctuationEffort = $('#slctliteracyeffortvocabularygrammarpunctuation').val();
			...
			if(sectionId != "" && studentIdNumber != "" && literacyReadingAchievement != "" &&
					...
					literacyVocabularyGrammarPunctuationAchievement != "" && literacyVocabularyGrammarPunctuationEffort != ""){
				...
				$.ajax({
				    url: 'savenarrationupperkeystagetwoyear6endyearprimaryschoolreport.jsp',		
				    data: dataString,
				    type:'POST',
