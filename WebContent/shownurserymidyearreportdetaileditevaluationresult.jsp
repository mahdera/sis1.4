...
<table border="0" width="100%" style="border: 0px solid #2779aa;" rules="all">
	...
	<tr>
		<td colspan="6">			
			<textarea name="textareanurserymidyearcomment" id="textareanurserymidyearcomment" class="jqte-test" rows="10" style="width:100%"><%=nurseryMidYearEvaluation.getNurseryMidYearComment() %></textarea>
		</td>
	</tr>
</table>
</div>
...
$(document).ready(function(){
	...
	$('#btnupdate').click(function(){		
		...
		if(nurseryMidYearComment != ""){
			var dataString = "&nurseryMidYearComment="+nurseryMidYearComment+"&id="+id;
			var divId = "nurseryMidYearReportDiv" + id;
			
			$.ajax({
			    url: 'updatenarriationnurserymidyear.jsp',		
			    data: dataString,
			    type:'POST',
