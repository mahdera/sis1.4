...
<form>
	<table border="0" width="100%">
		<tr style="background:#ccc;font-weight:bolder">
			...
			<td align="right">
				<input type="button" value="Show Report" id="btnshowreportnursery"/>
				<input type="reset" value="Clear"/>
			</td>
		</tr>
	</table>
</form>
<div id="nurseryReportDisplayDiv"></div>
<script type="text/javascript">
	$(document).ready(function(){
		$('#btnshowreportnursery').click(function(){
			var sectionId = $('#slctclass').val();
			var academicYear = $('#slctacademicyear').val();
			if(sectionId != "" && academicYear != ""){
				$('#nurseryReportDisplayDiv').load("showlistofnurserymidyearevaluationforthissectionandacademicyeareditevaluationresult.jsp?sectionId="+
