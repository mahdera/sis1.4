...
<%
	List<Section1> keyStageTwoSectionList = Section1.getAllSectionsOfThisLevel("Year 5 (Yr5)", "Year 5 (Yr5)");
...
<center><b>Key Stage Two Mid Year Primary School Report</b></center><br />
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#txtsection').change(function(){
			...
			if(id != ""){
				$('#namedisp').load("namedisplayforkstupperendyear.jsp?id="+id);
			}
		});
