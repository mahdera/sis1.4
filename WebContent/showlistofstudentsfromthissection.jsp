	...
	<%
		...
		while(itr.hasNext()){
			...
			%>
				...
				<td>
					<a href="#.jsp" onclick="showChangeSectionFormForThisStudent('<%=applicant.getId() %>','<%=sectionId%>');">Change Section</a>
				</td>
				<td>
					<a href="#.jsp" onclick="showDetailsOfThisApplicantForView('<%=applicant.getId()%>');">View Detail</a> 
				</td>
			</tr>
			<tr>
				<td colspan="10">
