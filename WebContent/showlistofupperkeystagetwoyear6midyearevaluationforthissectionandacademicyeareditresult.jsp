		...
		while(keyStageTwoMidYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showKeyStageTwoMidYear6ReportDetailEditResult(<%=keyStageTwoMidYearEvaluation.getId() %>);" class="showReportLinkClass">Edit Detail</a>
						|
...
<script type="text/javascript">
	function showKeyStageTwoMidYear6ReportDetailEditResult(id){
		var divId = "keyStageTwoMidYearReportDiv" + id;
		$('#'+divId).load("showupperkeystagetwomidyear6reportdetaileditresult.jsp?id="+id);
	}
