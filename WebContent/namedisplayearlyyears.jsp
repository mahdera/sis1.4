				...
				$.ajax({
				    ...
				    success:function(response){				    		
				    		if(response.trim() == "Saved"){				    			
				    			$('#textarea').html("<p class='msg warning'>End-year result is already saved for this student in this academic year!</p>");
							...
							$('#textarea').load('narrationforearlyyearsendofyear.jsp');
				    		}					
				    },
				    error:function(error){
						alert(error);
