...
<form>
	<table border="0" width="100%">
		<tr>
			...
			<td>
				<input type="button" value="Show Students" onclick="showListOfStudentsInThisTeachesValueForShow(document.getElementById('slctteaches').value,
					document.getElementById('slctteacher').value,document.getElementById('slctacademicyear').value,document.getElementById('slctterm').value);"/>
				<input type="reset" value="Clear"/>
			</td>
		</tr>
	</table>
</form>
<div id="studentListDivShow"></div>