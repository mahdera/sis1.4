		...
		while(keyStageTwoMidYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showKeyStageTwoMidYear6ReportDetail(<%=keyStageTwoMidYearEvaluation.getId() %>);" class="showReportLinkClass">Show Detail</a>
						|
...
<script type="text/javascript">
	function showKeyStageTwoMidYear6ReportDetail(id){
		var divId = "keyStageTwoMidYearReportDiv" + id;
		$('#'+divId).load("showupperkeystagetwomidyear6reportdetail.jsp?id="+id);
	}
