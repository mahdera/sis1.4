		...
		while(keyStageTwoMidYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showKeyStageTwoMidYear5ReportDetailEditResult(<%=keyStageTwoMidYearEvaluation.getId() %>);" class="showReportLinkClass">Edit Detail</a>
						|
...
<script type="text/javascript">
	function showKeyStageTwoMidYear5ReportDetailEditResult(id){
		var divId = "keyStageTwoMidYearReportDiv" + id;
		$('#'+divId).load("showupperkeystagetwomidyear5reportdetaileditresult.jsp?id="+id);
	}
