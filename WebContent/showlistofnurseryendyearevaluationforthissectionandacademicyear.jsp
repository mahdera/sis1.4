		...
		while(earlyYearsEndYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showNurseryEndYearReportDetail(<%=earlyYearsEndYearEvaluation.getId() %>);" class="showReportLinkClass">Show Detail</a>
						|
...
<script type="text/javascript">
	function showNurseryEndYearReportDetail(id){
		var divId = "nurseryEndYearReportDiv" + id;
		$('#'+divId).load("shownurseryendyearreportdetail.jsp?id="+id);
	}
