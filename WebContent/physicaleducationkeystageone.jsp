...
<center><b>PRIMARY SCHOOL SUMMARY RECORD FOR YEARS 1 & 2</b></center>
<%
...
<table width="100%" border="0" style="border: 1px solid #eee">
	...
	<tr>
		<td colspan="8" align="center"><B>EFFORT</B></td>
	</tr>
	<tr>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#txtsection').change(function(){
			...
			if(id != ""){
				$('#named').load("nameforphysicaleducationkeystageone.jsp?id="+id);
			}
		});
