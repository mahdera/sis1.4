...
<%
	...
	List<Applicant> a = StudentLevel.getLevelStudsInArchive(level);
	int ctr = 1;
	if(!a.isEmpty()){
...
<table border="0" id="studentProgressTable" class="display" cellspacing="0" width="100%">
	...
	<tr>
		<td colspan="8" align="right">
			<input type="button" value="Make Selected Student(s) Active" class="input-submit" id="btnmakeactive"/>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btnmakeactive').click(function(){
			if(window.confirm('Are you sure you want to activate the student record(s)?')){
				...
				$.ajax({
	                type: 'POST',
	                data: dataString,
	                url: 'activateselectedstudentsfromarchive.jsp',
