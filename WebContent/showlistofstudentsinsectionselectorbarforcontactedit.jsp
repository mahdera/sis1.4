...
List<Section> sectionList = Section.getAllSections();
	...
	if (role.isUpdateable() && role.isWritable()){
%>
<form>
	<table border="0" width="100%">
		<tr>
			...
			<td>
				<input type="button" value="Show" onclick="showListOfStudentsFromThisSectionForContactEdit(document.getElementById('slctsection').value);"/>
				<input type="reset" value="Clear"/>
			</td>
		</tr>
	</table>
</form>
<div id="studentListEditDiv" style="overflow-x:auto;"></div>
<%
				}else{
					%>
