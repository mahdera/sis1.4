		...
		while(keyStageOneEndYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showKeyStageOneEndYearReportDetailEditResult(<%=keyStageOneEndYearEvaluation.getId() %>);" class="showReportLinkClass">Edit Detail</a>
						|
...
<script type="text/javascript">
	function showKeyStageOneEndYearReportDetailEditResult(id){
		var divId = "keyStageOneEndYearReportDiv" + id;
		$('#'+divId).load("showkeystageoneendyearreportdetaileditresult.jsp?id="+id);
	}
