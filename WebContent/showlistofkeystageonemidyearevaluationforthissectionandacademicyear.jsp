		...
		while(keyStageOneMidYearEvaluationItr.hasNext()){
			...
			%>
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showKeyStageOneMidYearReportDetail(<%=keyStageOneMidYearEvaluation.getId() %>);" class="showReportLinkClass">Show Detail</a>
						|
...
<script type="text/javascript">
	function showKeyStageOneMidYearReportDetail(id){
		var divId = "keyStageOneMidYearReportDiv" + id;
		$('#'+divId).load("showkeystageonemidyearreportdetail.jsp?id="+id);
	}
