...
<td align="center"><div align="center"> <select id="txtsection" onChange="midyearreportforpp2(this.value)">
...
<td width="93" align="center"><input type="button" value="SHOW" onClick="javascript:showkeystageoneendeyear(document.getElementById('txtsection').value,document.getElementById('txtsid').value,document.getElementById('txtdob').value)"/></td>
</tr>
</table>
<br>
