		...
		$('#slctkeystageonesuboptions').change(function(){
			...
			if(selectedReportType != ""){
				if(selectedReportType == "key_stage_one_mid_year_report"){
					$('#keyStageOneReportDiv').load("showkeystageonemidyearclassandacademicyearselectorbareditresult.jsp");
				}else if(selectedReportType == "key_stage_one_end_year_report"){
					$('#keyStageOneReportDiv').load("showkeystageoneendyearclassandacademicyearselectorbareditresult.jsp");
				}
			}
		});
