...
<table border="1" width="100%">
	<tr style="background:#eeeeee">
		...
		<td>
			<input type="button" value="Show" onclick="showListOfStudentsInThisSectionForToWhom(document.getElementById('slctsection').value);"/>
		</td>
	</tr>
</table>
<div id="displayReportContentDivToWhom"></div>