...
<center style="font-size:15pt"><b>PRIMARY SCHOOL MID YEAR REPORT for YEAR 1-5</b></center>
<%
...
<tr style="background:#eee">
	<td colspan="4" style="font-size:13pt" align="center"><B>ACHIEVEMENT</B></td>
	<td colspan="4" style="font-size:13pt" align="center"><B>EFFORT</B></td>
</tr>
<tr>
	<td colspan="4">
		<table border="0" width="100%">
			...
			<tr>
				...
				<td>Meeting <strong>M</strong>ost Expectations</td>
...
<script type="text/javascript">
	$(document).ready(function(){		
		$('#txtsection').change(function(){
			...
			if(id != ""){
				$('#named').load("namedisplay2.jsp?id="+id);
			}
		});	
